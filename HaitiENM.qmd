...
```{r, echo = FALSE}
# In R, install and configure reticulate
install.packages("reticulate")
library(reticulate)

# Create a dedicated environment for climate data
#conda_create("climate_env")
#use_condaenv("climate_env")

# Install required Python packages
conda_install("climate_env", c("xarray", "rasterio", "geopandas", 
                                "requests", "netCDF4", "zarr", "dask"))
conda_install("climate_env", c("intake-esm", "regionmask"), pip = TRUE)
...
# Calculate zonal statistics for all rasters
cat("Calculating zonal statistics for Haiti administrative level 3...\n")

# Check raster types and convert if necessary
cat("Checking raster types...\n")
